...
@section('content')
    ...
    <!-- ABOUT GRAPHOLGY -->
    <section id="services"
        class="relative py-20 bg-gradient-to-b from-[#3E3229] via-[#2C241F] to-[#3E3229] overflow-hidden">
        <div class="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-6 text-center lg:text-left">
                ...
                <p class="text-gray-300 text-lg leading-relaxed">
                    Your handwriting is more than just letters on paper. Every stroke, curve, and space you create reflects
                    your
                    <span class="text-[#EBA35B] font-semibold">thoughts, emotions, and personality traits</span>.
                </p>
                <p class="text-gray-400 leading-relaxed">
                    At <span class="text-[#EBA35B] font-semibold">Shivansh Dargarh Transformation</span>, we specialize in
                    graphology — the science of understanding personality through handwriting.
                    With years of expertise, I have helped hundreds of people unlock their hidden strengths, weaknesses, and
                    potential using advanced handwriting analysis techniques.
                </p>
            ...
            <div class="relative">
                ...
                <!-- Glow Effect -->
                <div
                    class="absolute inset-0 bg-gradient-to-tr from-[#EBA35B]/20 via-transparent to-transparent rounded-2xl">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-6xl mx-auto text-center">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 text-gray-200">
                ...
                <div class="bg-[#524439] p-8 rounded-2xl shadow-xl hover:translate-y-[-6px] hover:shadow-2xl transition">
                    ...
                    <p class="text-gray-300">Recognized as one of the best graphologists in Kanpur with trusted reputation.
                    </p>
                </div>
                <!-- Card -->
                <div class="bg-[#524439] p-8 rounded-2xl shadow-xl hover:translate-y-[-6px] hover:shadow-2xl transition">
    ...
    <!-- CALL TO ACTION -->
    <section id="contact"
        class="relative py-24 px-6 lg:px-24 bg-gradient-to-r from-[#524439] via-[#3E3229] to-[#2C241F] text-center">
        <div class="max-w-4xl mx-auto">
            ...
            <p class="text-gray-200 text-lg leading-relaxed max-w-2xl mx-auto mb-10">
                Discover what your handwriting reveals about you. Get a personalized session with Shivansh Dargarh and take
            ...
            <div class="space-y-3 text-lg text-gray-300">
                <p><strong>Contact:</strong> <a href="tel:+919517291500" class="text-[#EBA35B] hover:underline">+91 95172
                        91500</a></p>
                <p><strong>Email:</strong> <a href="mailto:shivanshdargarhlts@gmail.com"
                        class="text-[#EBA35B] hover:underline">shivanshdargarhlts@gmail.com</a></p>
            </div>
        ...
        <!-- Glow Accent -->
        <div
            class="absolute inset-0 bg-gradient-to-tr from-[#EBA35B]/10 via-transparent to-transparent pointer-events-none">
        </div>
    </section>
@endsection
