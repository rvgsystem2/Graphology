    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="text-center mb-12">
        ...
        <p class="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
          Unlock your personality with the <span class="text-[#EBA35B] font-semibold">Best Handwriting Analyst in Kanpur</span>.
          Your handwriting is a mirror of your inner world—it reveals your emotions, thought patterns, and personality traits.
        </p>
      </div>
      ...
      <div class="grid md:grid-cols-2 gap-12 items-center mb-16">
        <div class="space-y-6">
          <p class="leading-relaxed">
            At <span class="text-[#EBA35B]">Shivansh Dargarh Transformation</span>, we offer detailed handwriting analysis sessions
            that help you understand yourself better and make confident life decisions. With years of experience, Shivansh Dargarh
            is widely recognized as the <span class="text-[#EBA35B] font-semibold">best handwriting analyst in Kanpur</span>,
            helping people from all walks of life achieve clarity and growth through accurate, personalized handwriting assessments.
          </p>
        </div>
        <div>
          <img src="https://cdn.pixabay.com/photo/2019/03/04/07/22/earth-4033438_1280.jpg"
               alt="Handwriting Analysis"
               class="rounded-2xl shadow-xl border border-gray-700">
        </div>
      </div>
  ...
  <section id="book-session" class="bg-[#3E3229] py-16 px-6 lg:px-24">
    <div class="max-w-4xl mx-auto text-center">
      ...
      <div class="grid gap-8 md:grid-cols-2">
        <!-- Phone -->
        <div class="bg-[#4A3A30] border border-[#EBA35B]/40 rounded-2xl p-6 shadow-lg hover:shadow-xl transition duration-300">
